...
<head>
  ...
  <title>Novi Salsya ELina - Mahasiswa Teknik Informatika</title>
...
<body>
  ...
  <div>
    <p>Hay Kenalkan Nama saya <?php echo $namaD . ' ' . $namaB; ?>. Saya seorang mahasiswa di <?php echo $kampus ?>, dengan
